...
const userFirstName = computed(() => user.value?.first_name || 'Doctor')
...
onMounted(async () => {
  ...
  try {
    ...
    if (response.ok) {
      ...
      errorMessage.value = data.message || 'Failed to load doctor dashboard'
    }
  } catch (error) {
...
<template>
  <div class="container mt-5" v-if="user">
    ...
    <div class="row mb-4">
      <div class="col-md-8">
        <h2>Welcome, Dr. {{ userFirstName }}!</h2>
      </div>
    </div>
      ...
      <div class="col-md-3 mb-4">
        <div class="card">
          <div class="card-body text-center">
            ...
            <p class="text-muted small">Today's Appointments</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 mb-4">
        <div class="card">
          <div class="card-body text-center">
            ...
            <p class="text-muted small">Pending Appointments</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-3 mb-4">
        <div class="card">
          <div class="card-body text-center">
            ...
            <p class="text-muted small">Total Treatments</p>
          </div>
        </div>
      </div>
